...
struct EmojiMemoryView: View {
    ...
    //Var Body is @ViewBuilder by default
    var body: some View {
        ...
        VStack{
            ...
            //Use background on views to see what they use/ the area
    ...
    private var cards: some View{
        ...
        AspectVGrid(viewModel.cards, aspectRatio: aspectRatio){ card in
            return CardView(card, cardColor: Color(viewModel.selectedTheme.cardColor))
                .padding(4) 
                .onTapGesture {
